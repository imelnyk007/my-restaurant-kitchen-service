...
class CategoryViewTests(TestCase):
    def setUp(self):
        self.user = Cook.objects.create_user(username='testuser', password='testpassword')
    ...
    def test_category_detail_view(self):
        url = reverse('kitchen:category-detail', kwargs={'pk': self.category1.pk})
    ...
    def test_category_update_view(self):
        url = reverse('kitchen:category-update', kwargs={'pk': self.category1.pk})
    ...
    def test_category_delete_view(self):
        url = reverse('kitchen:category-delete', kwargs={'pk': self.category1.pk})
    ...
    def test_category_list_view_with_search(self):
        ...
        self.assertIsInstance(response.context['search_form'], CategoryNameSearchForm)
